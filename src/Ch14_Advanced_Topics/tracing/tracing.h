...
SC_MODULE(tracing) {
  ...
  tracing(sc_core::sc_module_name nm,sc_core::sc_clock& clock);//Constructor
...
#endif
//Portions COPYRIGHT (C) 2004, 2007 Eklectically, Inc.-------------{{{//
...
//-----------------------------------------------------------------}}}//
//END $Id: tracing.h 761 2010-02-24 16:47:11Z dcblack $
