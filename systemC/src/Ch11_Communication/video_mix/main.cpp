...
unsigned errors = 0;
char* simulation_name = "video_mix";
char* simulation_vers = "$Header: /eklectICally/Project/ea/Cvsroot/Book2003/Examples/video_mix/main.cpp,v 1.5 2004/02/21 21:04:35 dcblack Exp $";
